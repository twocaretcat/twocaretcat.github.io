...
/**
 * Base page context type for social images pages that can be extended with additional properties. Image metadata is automatically added to pages of this type by {@link https://github.com/caret-collective/gatsby-plugin-component-to-image | gatsby-plugin-component-to-image}
 *
 * @typeParam T - Additional context properties
 */
