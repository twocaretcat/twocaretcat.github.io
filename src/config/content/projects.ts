	...
	[ProjectType.Other]: [
		{
			...
			languages: ['css', 'js', 'python', 'sql'],
			technologies: ['react', 'django', 'next', 'openstack'],
			tools: ['vscode'],
			topics: ['agile'],
		...
		},
		{
			...
			tools: ['chrome', 'firefox', 'edge', 'opera', 'vscode'],
		...
		},
		{
			...
			languages: ['js'],
			tools: ['jira', 'chrome', 'firefox', 'edge', 'opera', 'vscode'],
		...
		},
		{
			...
			tools: ['dependabot', 'git', 'github', 'prettier', 'vscode'],
			topics: [
				'branding',
				'ci-cd',
				'responsive-design',
		...
		{
			slug: 'caret-collective-cc',
			name: 'Caret Collective',
			description:
				'A responsive Vue landing page for an open-source software collective, featuring live GitHub project highlights and community links.',
			background:
				"Designed and developed the public website for Caret Collective, an independent home for open-source projects. The site presents the collective's principles, dynamically surfaces featured GitHub repositories through an Octokit-powered project grid with persisted client-side caching, and invites visitors to join the community with a CTA. Powered by Vue + Vite, the site is written in TypeScript and features dark-mode support, responsive section navigation, and a bold, bauhaus-inspired design. Automated unit and end-to-end tests with Vitest and Playwright ensure quality before deployment to Cloudflare Workers via GitHub Actions.",
			category: ProjectCategory.Website,
			schema: {
				type: SchemaType.Web,
				applicationCategory: SchemaApplicationCategory.Developer,
			...
			tools: ['git', 'github', 'oxfmt', 'oxlint', 'vscode'],
			topics: [
				'accessibility',
				'automated-testing',
				'ci-cd',
